...
const Profile = () => {
  ...
  const handleCreateSubmit = async (e) => {
    ...
    try {
      ...
      // Agrega el nuevo empleado creado al estado
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-grow bg-blue-50 rounded-lg p-6">
              <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div>
                  <p className="text-blue-900 font-medium">Password</p>
                  <p className="border-b border-gray-300 pb-1">
                    {currentEmployee.password || "—————"}
                  </p>
                </div>
                <div>
                  <p className="text-blue-900 font-medium">Rol</p>
                  <p className="border-b border-gray-300 pb-1">
              ...
              <div className="flex justify-center mt-6 gap-4">
                ...
                <button
                  className={`bg-gray-300 text-gray-800 px-6 py-2 rounded-md hover:bg-gray-400 transition-colors flex items-center gap-2 ${
                    !currentEmployee.id ? "opacity-50 cursor-not-allowed" : ""
                  }`}
                ...
                <button
                  className={`bg-red-200 text-red-900 px-6 py-2 rounded-md hover:bg-red-300 transition-colors flex items-center gap-2 ${
                    !currentEmployee.id ? "opacity-50 cursor-not-allowed" : ""
                  }`}
            ...
            <div className="bg-white rounded-lg w-full max-w-md p-6 shadow-2xl transform transition-all animate-pop-up">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 mb-6">
                  ...
                  {currentEmployee.nombre || "este empleado"}? Esta acción no se
                  puede deshacer.
                </p>
